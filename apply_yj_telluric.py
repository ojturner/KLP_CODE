...
def master_yj_telluric_correct(corr_dir):

    globbing_name = corr_dir + '/COMBINE_SCI_RECONSTRUCTED_*.fits'

    master_telluric_table = fits.open('/disk2/turner/disk2/turner/DATA/KLP/YJ/MASTER_TELLURIC/MASTER_TELLURIC_YJYJYJ.fits')
...
master_yj_telluric_correct('/disk2/turner/disk2/turner/DATA/KLP/YJ/GP3/goods_p3_comb_calibrated')