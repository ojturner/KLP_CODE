...
def vel_field_stott_binning_strong_line_constrained(incube,
                                                    sky_cube,
                                                    redshift,
                                                    threshold,
                                                    mask_x_lower,
    ...
    """
    Def:
    KLP K-band specific analysis (or analysis specific to the band in which
        both h-alpha and nitrogen fall). Going to first fit the H-alpha line
        and if and only if the constraints are met go on to fit the [NII] line
        constraining everything but the amplitude. 
    ...
    # we're dealing with the brightest line as
...
def klp_stott_binning_method_weak_line():